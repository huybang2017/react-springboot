      ...
      <div className="flex justify-between items-start w-full">
        ...
        >
          <div className="p-3" aria-labelledby="dateRangeButton">
            ...
            <button
              type="submit"
              className="inline-flex items-center px-3 py-2 mt-3 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Apply
            </button>
          </div>
